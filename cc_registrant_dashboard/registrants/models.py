...
class Registrant(models.Model):
    ...
    guest_type = models.CharField(
        choices=REGISTRANT_TYPE_CHOICES, default=STANDARD, max_length=3
    )
    current_status = models.CharField(
        choices=REGISTRANT_STATUS_CHOICES, default=REGISTERED, max_length=3
    )
...
class StatusChange(models.Model):
    ...
    status = models.CharField(
        choices=status_choices, default=Registrant.REGISTERED, max_length=3
    )
